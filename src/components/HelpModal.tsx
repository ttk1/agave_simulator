    ...
    <div className="modal-bg" onClick={() => setShowHelp(false)}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul className="muted" style={{ lineHeight: 1.7 }}>
          <li>🪟 窓際に置いた棚は自然光ボーナス (窓の高さに重なる中〜上段が有利)。LED の電気代を節約できる</li>
          <li>🔄 棚は自由に移動・回転できる。窓に近い配置ほど採光が良い</li>
          <li>夏は蒸れ (サーキュレーター推奨)、冬は寒さ (ヒーター推奨) に注意</li>
          <li>🌀 サーキュレーターの風は置いたマスの周囲8マスまで。守りたい棚の近くに置こう</li>
          <li>🐛 害虫は放置すると同じ棚 → 隣のマスの棚へとうつっていく。風の届く棚はうつりにくい</li>
          <li>LED は点けるほど室温が上がる。夏の高温対策にはエアコン (冷やした分だけ電気代増)</li>
          <li>鉢が大きいと乾きにくい。小苗は小鉢でスタート</li>
          <li>肥料をやりすぎると徒長して査定が下がる</li>
          <li>🛋️ 余裕ができたらインテリア (家具) で部屋を飾ろう。見た目だけで育成には影響しない</li>
          <li>株が育ったら根詰まりの前に植え替え</li>
          <li>🔪 当たり個体は胴切りチャレンジでクローン子株を量産できる。何個吹くかは運しだい！</li>
